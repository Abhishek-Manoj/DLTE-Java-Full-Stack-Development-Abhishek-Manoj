...
public class MinimumBalance {
    public static void main(String[] args){
        ...
        for(int i=0; i<20 ; i++){
            accBalance[i]=sc.nextDouble();                  //taking input from user for 20 account balances
        }
        MinimumBalance check = new MinimumBalance();        //creating object for the class MinimumBalance
